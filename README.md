...
| 순서 | 단원                                 | 수정 경로                                                                                                                                                                   |
| ---- | ------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1    | Context로 데이터 내려주기            | 1. `src/features/context-provider/NotificationContext.js`<br>2. `src/features/context-provider/NotificationProvider.jsx`<br>3. `src/features/context-provider/Exercise.jsx` |
